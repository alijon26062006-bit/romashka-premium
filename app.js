...
async function init(){
 try{
  ...
  if(!response.ok) throw Error('Products not found');
 ...
 }catch(e){$('#productGrid').innerHTML='<div class="loading">Не удалось загрузить каталог. Проверьте JSON-файл на GitHub Pages.</div>'}
}
